...
'<option value="0" SELECTED>Never</option><option value=".33">Sometimes</option><option value=".66">Moderately</option><option value="1.00">Very Often</option>'+
...
'(<a href="#" onclick="removePos('+field+','+feed.value+',\''+feed.text+'\'); return false;">remove</a>)';
   ...
   add.parentNode.parentNode.insertBefore(e,add.parentNode);   
