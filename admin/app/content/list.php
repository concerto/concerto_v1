<a href="<?=ADMIN_URL.'/content/new'?>"><div class="buttonsel"><div class="buttonleft"><img src="<?php ADMIN_BASE_URL ?>/images/buttonsel_left.gif" border="0" alt="" /></div><div class="buttonmid"><div class="buttonmid_padding">Submit Content</div></div><div class="buttonright"><img src="<?php ADMIN_BASE_URL ?>/images/buttonsel_right.gif" border="0" alt="" /></div></div></a><div style="clear:left;height:12px;"></div>
