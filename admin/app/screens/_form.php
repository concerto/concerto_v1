...
<h3>General Screen Settings <a href="http://signage.rpi.edu/admin/index.php/pages/show/docs/19#s2"><img class="icon" border="0" src="<?= ADMIN_BASE_URL ?>images/help_button.gif" alt="Extra Help" title="Extra Help" /></a></h3>
<br />
