...
define('ADMIN_URL', ROOT_URL.'admin');           //URL that can access this page (may be same as ADMIN_BASE_URL if mod_rewrite configured)

//Various configuration
define('CONCERTO_VERSION', '1.8.1');             //Version number.
define('DEFAULT_DURATION', 8);                   //Default content duration, in seconds
...
define('GA_TRACKING', '');                       //Define a Google Tracking id if applicable
define('TICKER_LIMIT', 150);                     //Ticket Text character limit
define('SYSTEM_EMAIL', '');                      //Email address used for system emails
?>
