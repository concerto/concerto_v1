...
//The following is a very quick and rough cut of an widget.  I am using this for some testing stuff with shuttle tracking and the internets.
//Please be advised while it is in the prod branch, it shouldn't be used for prod requests yet.
...
$type_av = array('graphic', 'text', 'html');
